...
#ifndef KITTI_VIEWER_CONFIG_H_
#define KITTI_VIEWER_CONFIG_H_
...
#define WINDOW_TITLE "KITTI Dataset Viewer"
#define ABOUT_TITLE "About This Application"
#define ABOUT_CONTENT "<p><b>KITTI Dataset Viewer</b> is a program that used to view the KITTI dataset entry.</p>"\
                "<p>For the user guide, please read the README file or github page.</p>"\
                "<p>https://github.com/lesterlo/KITTI-Viewer</p>"\
