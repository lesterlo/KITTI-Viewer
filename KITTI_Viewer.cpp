...
#include "config.h"
#include "../build/ui_KITTI_Viewer.h"
...
//Constructor
KITTI_Viewer::KITTI_Viewer (QWidget *parent) :
  QMainWindow (parent),
  ui (new Ui::KITTI_Viewer)
{
  prev_label_index = -1;
...
//QT initialzation 
void 
KITTI_Viewer::createActions()
{
  //@File->Open action
  openAct = new QAction(tr("&Open..."), this);
  openAct->setShortcuts(QKeySequence::Open);
  openAct->setStatusTip(tr("Open an existing file"));
  connect(openAct, &QAction::triggered, this, &KITTI_Viewer::openFolder);
  //@Help->About action
  aboutAct = new QAction(tr("&About"), this);
  aboutAct->setStatusTip(tr("Show the application's About box"));
  connect(aboutAct, &QAction::triggered, this, &KITTI_Viewer::about);
...
void 
KITTI_Viewer::contextMenuEvent(QContextMenuEvent *event)
{
    QMenu menu(this);
...
void 
KITTI_Viewer::labelUI_Signal_enable(bool state)
{
  if(state == true)
  {
...
void 
KITTI_Viewer::onFileListItemClicked(QListWidgetItem* item)
{
...
void 
KITTI_Viewer::onLabelListItemClicked(QListWidgetItem* item)
{
  if(item != NULL){//Prevent seg fault when clearing all items on QListWidget
...
void
KITTI_Viewer::onSaveButtonClicked()
{
  write_label();
}
...
void 
KITTI_Viewer::onInsertLabelButtonClicked()
{
  //Prepare new label
...
void 
KITTI_Viewer::onDeleteLabelButtonClicked()
{
...
void
KITTI_Viewer::onLabelEditFinish()
{
...
//Function is triggered when the label is out of focus or pressed enter
void 
KITTI_Viewer::onLabelValueChange(double)
{
  onLabelEditFinish();
}

void
KITTI_Viewer::onPrevPCDButtonClicked()
{
...
void
KITTI_Viewer::onNextPCDButtonClicked()
{
  int cur_row = ui->file_listWidget->currentRow();
  int total_row = ui->file_listWidget->count();
...
void
KITTI_Viewer::construct_labelWidget()
{
...
void 
KITTI_Viewer::label_UI_enable(int level, bool state)
{
    //label related ui
    switch(level)
    {
...
void 
KITTI_Viewer::drawAllLabel(int highlisted_index)
{
...
int 
KITTI_Viewer::read_label() //Read the label of the current pointcloud
{
